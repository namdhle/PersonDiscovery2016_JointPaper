...
Because human nature leads people to be very interested in other people, indices that represent the location and identity of people in the archive are indispensable for searching archives.
However, person discovery in the absence of prior identity knowledge requires accurate association of audio-visual cues and detected names. 
%
In this paper, we present 3 different strategies to approach this problem: clustering-based naming, verification-based naming, and graph-based naming.
%
