...
\mypartitle{Late fusion ranking.} Within each shot, $\{N^F_i, f(N^F_i)\}$ is the set of names returned by face naming and the corresponding talking scores and $\{N^A_i,  s(N^A_i)\}$  is the set of names returned by speaker naming.
%
